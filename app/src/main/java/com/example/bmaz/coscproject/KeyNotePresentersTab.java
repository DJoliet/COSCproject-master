 ...
 */
public class KeyNotePresentersTab extends Fragment {
    View thirdView;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        presentors = new String[]{"Keynote Presentor ", "Keynote Presentor 2", "Keynote Presentor 3", "Keynote Presentor 4"};

        presentorsInfo = new String[][]{
                {"First Info: Different stuff than the first tab. All of this stuff can be changed for each individual tab and presenter..."},
                {"second Info: This is where the topic and summary of the talk will go..." +
                        "blah blah balh blha words and stuff go here..."},
                {"Type whatever you want..... ;a;lsl ;alskdfj f fdjei d dida  dlfie f" +
                        "RANDOM CHARACTERS"},
